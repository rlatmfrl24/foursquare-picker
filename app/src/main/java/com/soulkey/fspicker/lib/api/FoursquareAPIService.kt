...
interface FoursquareAPIService {
    ...
    fun getRecommendByLL(@Query("ll") ll: String): Single<Response<RecommendVenueResponse>>

    @GET("v2/venues/{VENUE_ID}?$FOURSQUARE_BASIC_PARAM")
    fun getDetailById(@Path("VENUE_ID") fsId: String): Single<Response<VenueDetailResponse>>
}